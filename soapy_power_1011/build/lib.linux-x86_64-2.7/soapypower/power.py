...
class SoapyPower:
    ...
    def setup(self, bins, repeats, base_buffer_size=0, max_buffer_size=0, fft_window='hann',
        ...
        #print("!!!!!!!!!!!!!!! base_buffer in setup() !!!!!!!!!!!!!!!")#
        #print(base_buffer)#
        #print(len(base_buffer))#
    ...
    def psd(self, freq):
        ...
        for repeat in range(self._buffer_repeats):
            ...
            #print(self._buffer)#
            #iq_data_file = open('/home/zjchen/data2/', 'w')
            #numpy.set_printoptions(threshold = numpy.inf)
            #iq_data_file.write(str(self._buffer))
            #iq_data_file.close()
            #numpy.savetxt("/home/zjchen/data2/", self._buffer)
            #numpy.loadtxt("/home/zjchen/data2/")
